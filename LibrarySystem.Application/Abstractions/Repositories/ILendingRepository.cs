...
public interface ILendingRepository
{
    ...
    Task<IEnumerable<LendingActivity>> GetTopBorrowersAsync(DateTime start, DateTime end, int count,
        CancellationToken cancellationToken = default);

    Task<IEnumerable<LendingActivity>> GetUserHistoryAsync(int borrowerId, DateTime start, DateTime end,
        CancellationToken cancellationToken = default);
