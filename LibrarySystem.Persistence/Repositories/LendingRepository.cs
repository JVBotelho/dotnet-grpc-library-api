...
internal sealed class LendingRepository : ILendingRepository
{
    ...
    public async Task<IEnumerable<LendingActivity>> GetTopBorrowersAsync(DateTime start, DateTime end, int count,
    ...
    public async Task<IEnumerable<LendingActivity>> GetUserHistoryAsync(int borrowerId, DateTime start, DateTime end,
        CancellationToken cancellationToken = default)
    {
        return await _context.LendingActivities
            .Include(la => la.Book)
    ...
    public async Task<IEnumerable<LendingActivity>> GetByBookIdAsync(int bookId,
        CancellationToken cancellationToken = default)
    {
        return await _context.LendingActivities
